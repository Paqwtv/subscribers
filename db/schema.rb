...
ActiveRecord::Schema.define(version: 2020_02_23_195848) do
  ...
  create_table "subscribes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["program_id"], name: "index_subscribes_on_program_id"
    t.index ["user_id", "program_id"], name: "index_subscribes_on_user_id_and_program_id", unique: true
  ...
  add_foreign_key "subscribes", "programs"
